...
#/Developer/NVIDIA/CUDA-7.0/samples/common/inc/
LIBRARIES :=
...
# LIBRARIES += -lGL -lGLU ../../common/lib/darwin/libGLEW.a
 LIBRARIES += -lGL -lGLU $(CUDA_PATH)/samples/common/lib/darwin/libGLEW.a
...
################################################################################
#
#	ABOVE COPIED FROM VOLUMERENDER SAMPLE in CUDA 7 (THEN HEAVILY MODIFIED)
#
# Target rules
#
...
aligner_gpu.o:aligner_gpu.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(EXECUTABLE): $(OBJECTS) aligner_gpu.o
